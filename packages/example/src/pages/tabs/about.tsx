...
export default function About() {
  ...
  return (
    <view style={pageSlotStyle(p.surface)}>
      <scroll-view
        scroll-y
        style={{
          flexGrow: 1,
      ...
      >
        ...
        >
          <text
            ...
            style={{ marginBottom: px(12), color: p.onSurface }}
          >
          ...
          <text
            className="Hint"
            style={{ marginBottom: px(4), color: p.onSurfaceVariant }}
          >
          ...
          <text
            ...
            style={{ marginBottom: px(4), color: p.onSurfaceVariant }}
          >
            • Routes under /native — tamer-linking, tamer-display-browser, OAuth via
            tamer-auth, tamer-local-storage, tamer-webview, tamer-transports
          </text>
          <text
            className="Hint"
            style={{ marginBottom: px(4), color: p.onSurfaceVariant }}
          ...
          <text
            className="Hint"
            style={{ marginBottom: px(16), color: p.onSurfaceVariant }}
          >
