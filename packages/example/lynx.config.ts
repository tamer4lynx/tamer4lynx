...
export default defineConfig({
  resolve: {
    ...
    alias: {
      ...
      "@tamer4lynx/tamer-app-shell": path.resolve(
        __dirname,
        "../tamer-app-shell/src/index.tsx",
      ),
      "@tamer4lynx/tamer-navigation": path.resolve(
        __dirname,
        "../tamer-navigation/src/index.ts",
      ),
      "@tamer4lynx/tamer-router": path.resolve(
        __dirname,
        "../tamer-router/src/index.ts",
      ),
      "@tamer4lynx/tamer-router/plugin": path.resolve(
        __dirname,
        "../tamer-router/src/plugin.ts",
      ),
      "@tamer4lynx/tamer-router/generated-app-routes": path.resolve(
        __dirname,
        "node_modules/.tamer-router/_generated_app_routes.tsx",
      ),
      "@tamer4lynx/tamer-router/generated-lazy-flag": path.resolve(
        __dirname,
        "node_modules/.tamer-router/_tamer_lazy_routes_flag.ts",
      ),
      "@tamer4lynx/tamer-screen": path.resolve(
        __dirname,
        "../tamer-screen/src/index.tsx",
      ),
      "@tamer4lynx/tamer-icons": path.resolve(
        __dirname,
        "../tamer-icons/src/index.tsx",
      ),
      "@tamer4lynx/tamer-auth": path.resolve(
        __dirname,
        "../tamer-auth/src/index.ts",
      ),
      "@tamer4lynx/tamer-linking": path.resolve(
        __dirname,
        "../tamer-linking/src/index.ts",
      ),
      "@tamer4lynx/tamer-display-browser": path.resolve(
        __dirname,
        "../tamer-display-browser/src/index.ts",
      ),
    },
  },
  /**
  ...
  plugins: [
    ...
    // Keep ≤ Rspeedy encode max (3.5 here); native Lynx 3.6 runs these bundles.
    pluginReactLynx({ engineVersion: "3.5", firstScreenSyncTiming: "jsReady" }),
