...
import { loadExtensionConfig, hasExtensionConfig, getIosElements, getIosModuleClassNames, type NormalizedExtensionConfig } from '../common/config';
...
const autolink = () => {
    ...
    function resolvePodName(pkg: DiscoveredPackage): string {
    ...
    function syncInfoPlistPermissions(packages: DiscoveredPackage[]): void {
